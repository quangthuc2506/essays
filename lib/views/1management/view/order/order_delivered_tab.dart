...
class OrderDeliveredTab extends StatefulWidget {
  const OrderDeliveredTab({Key? key}) : super(key: key);
...
class _OrderDeliveredTabState extends State<OrderDeliveredTab> {
  ...
  void returnListOrderDelivered() {
    _orderRepo.getOrderDelivered().listen((pros) async {
      _listOrder = pros;
      setState(() {});
    });
  }
