            ...
            Container(
              ...
              child: TextFormField(
                onChanged: (value) async {
                  products = await _productRepository.getAllProduct2(value: value);
                  setState(() {});
                },
                      ...
                      : DropdownButtonFormField(
                          ...
                          onChanged: (dynamic value) async {
                            ...
                            if (value.categoryName == 'All') {
                              products =
                                  await _productRepository.getAllProduct2();
                              setState(() {});
                            } else {
                              products =
                                  await _productRepository.getProductsByCategoryId(value: value.categoryId);
                              setState(() {});
                            }
                          },
                          decoration: InputDecoration(
